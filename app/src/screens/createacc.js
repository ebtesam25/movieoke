    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ marginTop: '10%' }}>
                ...
                }}><Text style={{fontSize:25, fontFamily:'SourceCodeProBold'}}>Create account</Text>
                </Text> 
                <TextInput placeholder="full name" style={{fontFamily:'ProximaBold', fontSize:20, alignSelf:'center', color:'#373772',
                ...
                <TextInput placeholder="email address" style={{fontFamily:'ProximaBold', fontSize:20, alignSelf:'center', color:'#373772', marginTop:'5%',
                paddingLeft:'5%', textAlign:'left', width:'80%', backgroundColor:'#F4F7FF', borderRadius:50, paddingVertical:'5%'}} placeholderTextColor={`rgba(55, 55, 114, 0.3)`}></TextInput>
                ...
                paddingLeft:'5%', textAlign:'left', width:'80%', backgroundColor:'#F4F7FF', borderRadius:50, paddingVertical:'5%'}} placeholderTextColor={`rgba(55, 55, 114, 0.3)`}></TextInput>
                <TextInput secureTextEntry placeholder="confirm password" style={{fontFamily:'ProximaBold', fontSize:20, alignSelf:'center', color:'#373772', marginTop:'5%',
                paddingLeft:'5%', textAlign:'left', width:'80%', backgroundColor:'#F4F7FF', borderRadius:50, paddingVertical:'5%'}} placeholderTextColor={`rgba(55, 55, 114, 0.3)`}></TextInput>
            </View>
